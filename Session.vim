...
map ,te :tabedit
map ,tn :tabnew
map ,bd :silent! bp|sp|silent! bn|bd
nmap <silent> , :noh
nmap <silent> ,qa :qa
nmap <silent> ,qq :q
nmap <silent> ,qf :q!
...
set guifont=DejaVu\ Sans\ Mono\ for\ Powerline\ 10,DejaVu\ Sans\ Mono\ 10,Courier\ New\ 10,Courier\ 10,Luxi\ Mono\ 10,SimSun\ 10,WenQuanYi\ Micro\ Hei\ Mono\ 10
set helplang=en
set history=4000
set hlsearch
set incsearch
...
exe 'vert 1resize ' . ((&columns * 25 + 99) / 199)
exe 'vert 2resize ' . ((&columns * 142 + 99) / 199)
exe 'vert 3resize ' . ((&columns * 30 + 99) / 199)
argglobal
enew
file NERD_tree_1
let s:cpo_save=&cpo
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 225 - ((9 * winheight(0) + 22) / 45)
...
setlocal spellfile=
setlocal spelllang=en
setlocal statusline=%#airline_a_inactive# Tagbar %#airline_a_to_airline_b_inactive#%#airline_b_inactive# Name %#airline_b_to_airline_c_inactive#%#airline_c_inactive# .vimrc 
setlocal suffixesadd=
setlocal noswapfile
setlocal synmaxcol=3000
if &syntax != 'tagbar'
